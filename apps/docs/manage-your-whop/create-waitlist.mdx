---
title: "How to create a waitlist"
description: "Have people join a waitlist before they can access your whop"
---

A waitlist puts you in control of who joins your whop. People apply to join, you review them, then approve the ones you want.

It's great for collecting leads, vetting potential members, and giving your whop an aura of exclusivity. 
...
- Find your waitlist link and click on the **3 dots** (⋮)
- Click **Edit**
...
- **Vet potential customers** — Add custom questions to qualify leads before giving them access, saving you time and setting clear expectations.
- **Create exclusivity for your community** — When people have to apply and wait for approval, it makes your whop feel more valuable and desirable. The application process itself creates demand.
- **Transition from free to paid** — Use a waitlist to segment your most loyal users, gather feedback, and gradually roll out pricing changes.
