...
You can easily process refunds from your Whop dashboard.
...
<Tip>
  Refunds process immediately, and you'll see the refund appear on the customer's profile right away.
</Tip>
...
If your Whop doesn't have sufficient funds for a refund, you'll need to add money to your account first.
...
<AccordionGroup>
  ...
  <Accordion title="How long does it take for customers to receive their refund?">
