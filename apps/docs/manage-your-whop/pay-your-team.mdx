...
You can send money instantly to any team member or user on Whop.
...
1. Click the user's profile picture
   - If you know their username, go straight to their profile by entering **whop.com/@[username]** in your browser’s address bar (e.g., **whop.com/@dylaneastwood**).
