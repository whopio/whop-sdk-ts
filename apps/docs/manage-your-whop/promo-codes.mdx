...
Promo codes let set up percentage discounts (like 10% off) or fixed amounts (like \$10 off) - perfect for limited-time sales, closing hesitant customers, or running flash promotions.
