...
Verifying your domain will require you to host [this file](https://whop.com/.well-known/apple-platform-integrator/apple-developer-merchantid-domain-association) on `https://<your-domain>/.well-known/apple-developer-merchantid-domain-association`. Please refer to your framework's or hosting provider's documentation on how to host this file.
