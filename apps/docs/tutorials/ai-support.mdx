# AI Support Bot Setup Guide

Build a production-ready AI support bot that intelligently answers questions in your Whop communities with 80%+ cost savings through smart question detection and caching.

Try it out here: https://whop.com/apps/app_3rqpGo1tsmPDHg/install/
...
<Steps>
  ...
  <Step title="Get your API Key, Bot User ID, and App ID">
    After creating your app:
    1. Copy the **App API Key** - you'll need this for `WHOP_APP_API_KEY`
    2. Copy the **Bot User ID** - you'll need this for `WHOP_AGENT_USER_ID`
    3. Copy the **App ID** - you'll need this for `WHOP_APP_ID`
    
    <Note>
      The Bot User ID is what allows your bot to send messages on behalf of your app.
    </Note>
  </Step>
</Steps>
...
<Steps>
  <Step title="Test in Your Community">
...
<AccordionGroup>
  ...
  <Accordion title="AI responses not working">
    ...
    2. Make sure the bot is enabled in the settings dashboard
    3. Verify the knowledge base is not empty
    4. Check the bot console for any AI-related errors
  </Accordion>
