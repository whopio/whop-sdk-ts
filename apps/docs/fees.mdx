...
Whop charges 2.5% \+ 30c on every card transaction that takes place on Whop. 

No service fees. No marketplace fees. Just 2.5% \+ 30c --the cheapest payment processing on the internet.
