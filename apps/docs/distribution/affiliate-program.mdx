...
3. Configure their reward:
   - Choose between **Percent** or **Fixed amount**
...
Whop automatically handles all affiliate payments for you. There is a 30-day waiting period from when a referred customer makes their purchase and when the affiliate receives their commission. This waiting period protects your business from potential disputes and refunds.