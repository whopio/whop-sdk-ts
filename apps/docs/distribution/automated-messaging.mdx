...
description: "Learn how to send automated marketing messages to your members on Whop"
---

You can set up automated messages on Whop to send personalized DMs when:

1. Someone joins your Whop;
2. Someone leaves your Whop; and
3. Someone checks out your store page but doesn't buy.

Set them up once and let Whop handle the rest while you focus on growing your business.

## How to find automated messages
...
Send welcome messages automatically when new members join your whop.
...
<Steps>
  ...
  <Step title="Set up your automated message" titleSize="h3">
    ...
    - **Personal touches**: Add these variables to make it feel custom and personalized:
...
<Steps>
  <Step title="Enable popup promotions on Whop" titleSize="h3">
    ...
    <Card title="Set up popup promotions" icon="hand-wave">
...
Your automated messages are now active and will send personalized messages to members and leads based on their interactions with your whop. You can return to these settings anytime to change your messages or turn automations on and off.