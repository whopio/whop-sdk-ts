...
<Card
  title="Build a prioritization board"
  href="/tutorials/prioritization-board"
  icon="book"
  color="#0ea5e9"
>
  Learn how to build an issue prioritization board with forum posts and push notifications. 
</Card>
...
<Card
  ...
  color="#ec4899"
>
  Create a virtual drawing board that can be installed in any whop.
</Card>
</CardGroup>
