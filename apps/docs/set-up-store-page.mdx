...
Your store page is where visitors come to learn about what you offer - think of it as your digital shop that's open 24/7. It shows details about your product, pricing, answers common questions, and highlights testimonials.

Follow along to create a professional-looking store page for your business on Whop in less than 5 minutes.
...
<Steps>
  ...
  <Step title="Add gallery images" titleSize="h3">
    ...
    2. Click \*\*Upload media \*\*and select the media files you want to show in your gallery
       ...
       - We recommend uploading images with 16:9 aspect ratio
...
- **Store page URL**: Your custom web address for this specific offer/ whop
...
- **The gallery**: The image or videos that sit in the banner at the top of your store page
...
That’s it. You have a clean and professional store page for your internet business.

To get your business up and running on Whop, make sure you've completed the rest of the setup steps:

<CardGroup cols={2}>
  <Card title="Create your whop" icon="sparkles" href="www.google.com">
