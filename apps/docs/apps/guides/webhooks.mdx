---
title: Webhooks
description: Receive payment, membership and other events from whop programatically
---

Use webhooks to handle and respond to whop events in realtime.

1. validating webhook authenticity
2. setting up a webhooks
3. schema + available webhooks
