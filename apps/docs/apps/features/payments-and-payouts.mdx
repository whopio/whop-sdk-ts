...
<Warning>
  Make sure to create a webhook and set your `WHOP_WEBHOOK_SECRET` environment variable. You can find it in your Whop app settings under the Webhooks section.
</Warning>
