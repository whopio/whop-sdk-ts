...
const result = await whopSdk.attachments.uploadMedia({
	...
	record:
		"abuse_report" /* Valid values: abuse_report | access_pass | access_pass_collection | app | assessment_question | automated_messages_config | bot | bounty | bounty_submission | competition_prize | content_reward_campaign | content_reward_submission | course_lesson | dispute | dms_post | experience | forum_post | resolution_event_upload | review | review_report | user */ /* Required! */,
});
