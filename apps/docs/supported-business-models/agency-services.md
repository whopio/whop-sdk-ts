...
<Steps>
  <Step title="Create your whop" titleSize="h3">
    ...
    ![Createwhopagencies Png](/apps/docs/images/createwhopagencies.png)
  ...
  <Step title="Add the Calendar Bookings app" titleSize="h3">
    ...
    ![Add Calendar Bookings app](/apps/docs/how-to-videos/calendarbookingstoagency.gif)
  ...
  <Step title="Add the Files app" titleSize="h3">
    ...
    ![Add Files app](/apps/docs/images/addfilestoagency.png)
  ...
  <Step title="Add the Content app" titleSize="h3">
    ...
    ![Add Content app](/apps/docs/images/addingcontenttoagencies.png)
  ...
  <Step title="Add the Chat app (optional)" titleSize="h3">
    ...
    ![Add Chat app](/apps/docs/images/addingchattoagencies.png)
  ...
  <Step title="Design your store page" titleSize="h3">
    ...
    ![Agency store page](/apps/docs/images/storepageagencies.png)
...
<Card
  title="Grow your agency on Whop"
  icon="chart-line"
