...
<Steps>
  ...
  <Step title="Design your store page" titleSize="h3">
    Your store page is where people decide whether to book with you. A clean, clear page that shows the results you help people achieve will convert more visitors into paying clients. Click your whop name in the top left, then select **Design store page** to open the editor. Click **Edit details** to customize:
    ...
    - **Select the appropriate category**: This helps people discover your coaching when browsing Whop
  </Step>
  <Step title="Set up pricing and Whop Payments" titleSize="h3">
    ...
    - **Free access:** Clients get access to your whop for free, but pay for infividual calls through the **Calendar Bookings** app
