...
<Steps>
  ...
  <Step title="Add the Chat app" titleSize="h3">
    Your clients need support between sessions, not just during them. The [**Chat**](https://whop.com/apps/app_xml5hbizmZPgUT/install/) app keeps clients engaged and motivated while creating a space where they can connect with each other and share wins.
