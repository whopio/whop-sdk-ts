...
<Steps>
  ...
  <Step title="Set up pricing" titleSize="h3">
    ...
    Click your whop name at the top left of your dashboard, select **Manage Pricing**, and then click **Create a pricing option** at the bottom right of the popup. You can structure your pricing as free access, a one-time payment, or a recurring subscription. For example:
