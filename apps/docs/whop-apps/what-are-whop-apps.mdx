...
- **Trading indicators app**: Lets you sell custom trading indicators to your members

**For reselling communities**

- **Marketplace app**: Create a space where your users can buy and sell products with each other
- **Resale price database app:** Tracks current and past values for various products and collectibles

**For AI communities**

- **Prompt library app**: Create, share, and sell AI prompts to help members get better results from AI tools
- **AI image generator app**: Lets your members generate AI images inside your whop
